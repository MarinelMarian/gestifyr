...
trigger_release_time = 1.5  # in seconds, how much time should pass until next trigger
...
# Model parameters
metadata_filename = (
    f"{BASE_PATH}{APP_REL_PATH}model/for_final_final/gru_128_4_0.001_5/info_model.txt"
)
