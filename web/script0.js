...
const shakeThreshold = 0.3; // Adjust for sensitivity
const bufferSize = 10; // Number of frames to store (approx 3 seconds at 30 fps)
...
function onResults(results) {
  ...
  */
    ...
    if (face_2d.length > 0) {
        ...
        playAudioIfDetected(yesConfig, nodDetected);
        playAudioIfDetected(noConfig, shakeDetected);
